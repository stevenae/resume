...
\oddsidemargin=-26.9mm   % to start box .5in from left of page
...
\hsize=8.4in \vsize=13in             % use bigger dimensions for box
\newbox\MACboxA  \newdimen\MACdimenA
...
\vspace{.2in}
\hfil{\LARGE Steven Ellis}\hfil

\vspace{.5in}

\hfil{\Large Data Science Leader}\hfil
...
%\begin{flushright}{\Large\zapfinofont Thank You}\end{flushright}
