...
\vspace{6mm}
\begin{list}{}{\leftmargin=1em}
\item \textbox{United States Digital Service\dotfill}\textbox{Data Scientist\dotfill}\textbox{1/2023 -- 6/2023}
\begin{list}{-}{\leftmargin=1em}
\item Produced federal government's first comprehensive analysis of federal funding for Puerto Rico.
\end{list}
\vspace{4mm}
\item \textbox{GoBuild\dotfill}\textbox{Data Scientist\dotfill}\textbox{7/2020 -- 6/2021}
\begin{list}{-}{\leftmargin=1em}
...
\end{list}
\vspace{4mm}
\item \textbox{Divvy Homes\dotfill}\textbox{Head of Data Science\dotfill}\textbox{9/2018 -- 6/2020}
\begin{list}{}{\leftmargin=1em}
