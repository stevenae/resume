...
\topmargin=-9mm       % to start box .5in from top of page
\oddsidemargin=-7.5mm   % to start box .5in from left of page
...
\hsize=6.85in \vsize=12in             % use bigger dimensions for box
\newbox\MACboxA  \newdimen\MACdimenA
...
\begin{list}{--}{\leftmargin=1em}
\item I currently work for the United States Digital Service (January 2023\,- Now). So far I have summarized available data sets for the White House Working Group on Puerto Rico.

\item I was the second employee at GoBuild (July  2020\,-\,June 2021), a seed-stage startup. I developed and piloted the startup's product, a tool which estimated the effect of home renovations on resale value.

\item I was the first data scientist at Divvy Homes (September  2018\,-\,June 2020). I built and deployed core data products which determined home pricing and financing approval. I also hired and managed two data scientists.

\item I was the sixth data scientist at Uber (May  2014\,-\,December  2016).  I quantified the value of business partnerships via causal inference methods. I also resolved hazardous flaws in Uber's feature rollout infrastructure.
