...
\item Experimental \& observational research on choice and decision-making.
%\item Technical collaboration and  using Github, AWS, Heroku.
\item Collaborative development and deployment: R, Python, Git, AWS, Heroku.
...
\item Audience-aware technical communication.
\item Hiring, team- and relationship-building.
...
\vspace{0.5mm}
\begin{list}{}{\leftmargin=1em}\itemsep-2pt
\item Guided pricing and product strategy using hierarchical bayesian modeling of discrete choice data.% (\textcolor{blue}{\href{https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/41381.pdf}{{link}}}).
\item Identified surrogate geographic research regions by applying exact-test statistics to census data.% (\textcolor{blue}{\href{http://steven.ae/ama_poster.pdf}{{link}}}).
