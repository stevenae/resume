...
\topmargin=-22.3mm       % to start box .5in from top of page
...
\item{\textbf{Experience}\dotfill
\begin{list}{-}{\leftmargin=1em}
\item{\textbf{United States Digital Service (Washington, D.C., January 2023\,-\,Current)}
\begin{list}{--}{\leftmargin=1em}
\item Summarized available data sets for the White House Working Group on Puerto Rico.
\end{list}}

\item{\textbf{GoBuild (Remote, USA, July  2020\,-\,June 2021)}  
\begin{list}{--}{\leftmargin=1em}
\item Developed and piloted data product demonstrating effect of home renovations on resale value.
\end{list}}

\item{\textbf{Divvy Homes (San Francisco, CA, September  2018\,-\,June 2020)}  
\begin{list}{--}{\leftmargin=1em}
...
\item{\textbf{Uber (San Francisco, CA, May  2014\,-\,December  2016)}
\begin{list}{--}{\leftmargin=1em}
