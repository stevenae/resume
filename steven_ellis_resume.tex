...
\begin{list}{-}{\leftmargin=1em}
\item Sole data scientist and USDS presence  on White House Working Group on Puerto Rico.
\item Used USASpending.org APIs, R, and Python to produce analysis of funding for Puerto Rico.
\end{list}
...
\item Used R to develop XGBoost models of home pricing and creditworthiness.
...
\begin{list}{-}{\leftmargin=1em}
\item Used Python/Pandas, Random Forest to quantify business partnership value.
\item Built dashboards in D3.js, Looker to track partnerships rollouts.
